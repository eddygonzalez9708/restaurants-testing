...
public class SeedData implements CommandLineRunner
{
    ...
    public void run(String[] args) throws Exception
    {
        ...
        Restaurant r1 = new Restaurant(rest1Name,
                ...
                allPay);
        r1.getMenus().add(new Menu("T Mac and Cheese", 6.95, r1));
        r1.getMenus().add(new Menu("T Lasagna", 8.50, r1));
        r1.getMenus().add(new Menu("T Meatloaf", 7.77, r1));
        r1.getMenus().add(new Menu("T Tacos", 8.49, r1));
        r1.getMenus().add(new Menu("T Chef Salad", 12.50, r1));

        r1 = restaurantrepos.save(r1);
        ...
        Restaurant r3 = new Restaurant(rest3Name,
                ...
                noCashPay);
        r3.getMenus().add(new Menu("T Pizza", 15.15, r3));

        r3 = restaurantrepos.save(r3);
